...
**Άσκηση E1A6** - Αν προστεθεί ο ακέραιος αριθμός 28706162 στο τέλος του κειμένου "ΠΑΝΕΠΙΣΤΗΜΙΟ ΙΩΑΝΝΙΝΩΝ", το νέο κείμενο "ΠΑΝΕΠΙΣΤΗΜΙΟ ΙΩΑΝΝΙΝΩΝ28706162" θα έχει hash τιμή (με τη συνάρτηση κατακερματισμού SHA256) με τα 7 τελευταία ψηφία μηδέν. Αυτό φαίνεται στον ακόλουθο κώδικα: 
...
Ζητήστε από το ChatGPT ή άλλο να εξηγήσει αναλυτικά το ρόλο της εντολής: ```hashlib.sha256(text.encode()).hexdigest()```.
