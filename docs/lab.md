...
Στο εργαστήριο του μαθήματος οι γλώσσες προγραμματισμού θα χρησιμοποιηθεί η γλώσσα προγραμματισμού Python για την παρουσίαση χαρακτηριστικών των 3 βασικών προγραμματιστικών υποδειγμάτων: α) προστακτικός προγραμματισμός, β) συναρτησιακός προγραμματισμός και γ) λογικός προγραμματισμός.
