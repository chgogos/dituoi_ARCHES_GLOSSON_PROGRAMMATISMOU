...
def plot():
    ...
    # Enter your API key
    api_key = "b5ef85710091b0a255f9c7e3ba5f2609" 
    ...
    for _ in range(5):
        ...
        # API url
        weather_url = 'https://api.openweathermap.org/data/2.5/onecall/timemachine?lat=' + lat + '&lon=' + lon + '&units=metric&dt=' + str(utc_time) + '&appid=' + api_key
