...
Η δεσμευμένη λέξη extern χρησιμοποιείται συνήθως για να δηλωθεί μια μεταβλητή που ορίζεται σε ένα άλλο αρχείο.Όταν δηλωθεί μια μεταβλητή ως extern αυτό σημαίνει ότι ορίζεται κάπου εξωτερικά του σημείου δήλωσης και ο χώρος αποθήκευσής της υπάρχει κάπου αλλού,όχι με τις μεταβλητές που είναι ορισμένες στο τρέχον τμήμα κώδικα. Για περισσότερα δείτε το 4.3 Κατηγορίες αποθήκευσης από το [^1]
...
[^1]:[Μια σύγχρονη προσέγγιση στη γλώσσα C. Κάλλιπος, Ανοικτές Ακαδημαϊκές Εκδόσεις](https://repository.kallipos.gr/handle/11419/11683?&locale=el)
